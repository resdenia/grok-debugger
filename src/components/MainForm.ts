...
export const MainForm = (className: string = 'formGrok') => {
	...
	const textareaFieldLog = textareaField('textarea', ['form-field', 'form-field__log', 'form-field__log-dark']);

	const textareaFieldPattern = textareaField('textarea', ['form-field', 'form-field__pattern', 'form-field__pattern-dark']);
